...
set rc [catch {
  ...
  set_property ip_repo_paths d:/ch4_ps/ch4_ps.cache/ip [current_project]
  set_property ip_output_repo d:/ch4_ps/ch4_ps.cache/ip [current_project]
  add_files -quiet D:/ch4_ps/ch4_ps.runs/synth_1/system_wrapper.dcp
  read_xdc -ref system_processing_system7_0_0 -cells inst d:/ch4_ps/ch4_ps.srcs/sources_1/bd/system/ip/system_processing_system7_0_0/system_processing_system7_0_0.xdc
  set_property processing_order EARLY [get_files d:/ch4_ps/ch4_ps.srcs/sources_1/bd/system/ip/system_processing_system7_0_0/system_processing_system7_0_0.xdc]
...
set rc [catch {
  ...
  if { [file exists D:/ch4_ps/ch4_ps.runs/synth_1/system_wrapper.hwdef] } {
    catch { write_sysdef -hwdef D:/ch4_ps/ch4_ps.runs/synth_1/system_wrapper.hwdef -bitfile system_wrapper.bit -meminfo system_wrapper.mmi -file system_wrapper.sysdef }
  }
