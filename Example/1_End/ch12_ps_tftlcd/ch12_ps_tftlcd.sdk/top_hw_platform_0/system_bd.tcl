...
proc create_root_design { parentCell } {
  ...
  set M_AHB_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:ahblite_rtl:1.0 M_AHB_1 ]

  # Create ports
  set m_ahb_hclk [ create_bd_port -dir O -type clk m_ahb_hclk ]
  set m_ahb_hclk_1 [ create_bd_port -dir O -type clk m_ahb_hclk_1 ]
  set m_ahb_hmastlock [ create_bd_port -dir O m_ahb_hmastlock ]
  set m_ahb_hmastlock_1 [ create_bd_port -dir O m_ahb_hmastlock_1 ]
  set m_ahb_hresetn [ create_bd_port -dir O -from 0 -to 0 -type rst m_ahb_hresetn ]
  set m_ahb_hresetn_1 [ create_bd_port -dir O -from 0 -to 0 -type rst m_ahb_hresetn_1 ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_1_m00_axi [get_bd_intf_pins axi_ahblite_bridge_1/AXI4] [get_bd_intf_pins processing_system7_0_axi_periph_1/M00_AXI]
  ...
  connect_bd_net -net axi_ahblite_bridge_1_m_ahb_hmastlock [get_bd_ports m_ahb_hmastlock_1] [get_bd_pins axi_ahblite_bridge_1/m_ahb_hmastlock]
  connect_bd_net -net proc_sys_reset_interconnect_aresetn [get_bd_pins proc_sys_reset/interconnect_aresetn] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/ARESETN]
  connect_bd_net -net proc_sys_reset_peripheral_aresetn [get_bd_ports m_ahb_hresetn] [get_bd_ports m_ahb_hresetn_1] [get_bd_pins axi_ahblite_bridge_0/s_axi_aresetn] [get_bd_pins axi_ahblite_bridge_1/s_axi_aresetn] [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph_1/S00_ARESETN]
  connect_bd_net -net processing_system7_0_fclk_clk0 [get_bd_ports m_ahb_hclk] [get_bd_ports m_ahb_hclk_1] [get_bd_pins axi_ahblite_bridge_0/s_axi_aclk] [get_bd_pins axi_ahblite_bridge_1/s_axi_aclk] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP1_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins processing_system7_0_axi_periph_1/ACLK] [get_bd_pins processing_system7_0_axi_periph_1/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph_1/S00_ACLK]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs M_AHB_1/Reg] SEG_M_AHB_1_Reg
