...
int main()
{
    ...
    u32 *image1 = 0x10400000;

    /* clear image array start */
    memset(image0, 0, IMG_WIDTH*IMG_HEIGHT*4);
    memset(image1, 0, IMG_WIDTH*IMG_HEIGHT*4);
    /* clear image array end */

    /* VDMA initialization start */
    initialize_vdma_read_channel(XPAR_AXI_VDMA_0_BASEADDR, image1, (LCD_WIDTH), LCD_HEIGHT, (IMG_WIDTH));
    initialize_vdma_write_channel(XPAR_AXI_VDMA_1_BASEADDR, image0, (IMG_WIDTH), IMG_HEIGHT, (IMG_WIDTH));
    initialize_vdma_write_channel(XPAR_AXI_VDMA_2_BASEADDR, image1, (IMG_WIDTH), IMG_HEIGHT, (IMG_WIDTH));
    //initialize_vdma_read_channel(XPAR_AXI_VDMA_3_BASEADDR, image1, (LCD_WIDTH), LCD_HEIGHT, (IMG_WIDTH));
    /* VDMA initialization start */
